...
Allcities <- read.csv("C:/Users/schel/Documents/Master thesis/Huizenmarkt 2/Data/Funda/URBAN_FUNDA_FULL (2).csv")
...
merged_data <- merged_data %>%
  rename(sted = ...130)
write.csv(merged_data, file = paste0(dirToSave, "URBAN_CBS_FULL POSTCODES (2).csv"), row.names = FALSE)
