...
fulldata <- read.csv("C:/Users/schel/Documents/Master thesis/Huizenmarkt 2/Data/CBS/URBAN_CBS_FULL.csv")
...
write.csv(mergedVerkiezing, file = "C:/Users/schel/Documents/Master thesis/Huizenmarkt 2/Data/CBS GROEN STEMMERS/URBAN CBS GROEN.csv", row.names = FALSE)
