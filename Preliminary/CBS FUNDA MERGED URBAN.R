...
Allcities <- read.csv("C:/Users/schel/Documents/Master thesis/Huizenmarkt 2/Data/Funda/URBAN_FUNDA_FULL.csv")
...
filtered_data <- merged_data %>%
  filter(city == gm_naam)
write.csv(filtered_data,file = "C:/Users/schel/Documents/Master thesis/Huizenmarkt 2/Data/CBS/URBAN_CBS_FULL.csv", row.names = FALSE)
